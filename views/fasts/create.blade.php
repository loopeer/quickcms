                                        ...
                                        @foreach($model->create as $item)
                                            <section id="{{ str_replace('.', '_', $item['column']) }}_section">
                                                ...
                                                @elseif($item['type'] == 'password')
                                                    <label class="input">
                                                        <input type="password" name="{{ $item['column'] }}" value="{{ old($item['column']) ?: null }}" @if(isset($item['disabled']) && isset($data->id))) disabled @endif>
                                                    </label>
                                                                ...
                                                                <div class="input-group date form_datetime" data-date-format="yyyy-mm-dd hh:ii:ss">
                                                                    @else
                                                                        ...
                                                                        @elseif($item['type'] == 'voice')
                                                                            @include('backend::voice.upload', ['voice' => $item, 'voice_name' => $item['column']])
...
@section('script')
    ...
    @foreach($model->create as $itemImage)
        ...
        @if(isset($itemImage['type']) && $itemImage['type'] == 'voice')
            @include('backend::voice.action', ['voice' => $itemImage, 'voice_data' => $data->{$itemImage['column']}])
        @endif
