<link rel="stylesheet" type="text/css" href="{{{ asset('backend/js/blueimp/css/jquery.fileupload-ui.css') }}}">
<link rel="stylesheet" type="text/css" href="{{{ asset('backend/js/blueimp/css/blueimp-gallery.min.css') }}}">
<script src="{{ asset('backend/js/blueimp/tmpl.min.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/load-image.min.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/canvas-to-blob.min.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/bootstrap-image-gallery.min.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/jquery.iframe-transport.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/jquery.fileupload.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/jquery.fileupload-process.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/jquery.fileupload-image.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/jquery.fileupload-validate.js') }}"></script>
<script src="{{ asset('backend/js/blueimp/jquery.fileupload-ui.js') }}"></script>
